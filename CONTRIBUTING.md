...
Before you ask a question, it is best to search for existing [issues](https://github.com/v0idx/byte_printer/issues) that might help. In case you have found a suitable issue and still need clarification you can write your question in this issue. It is also advisable to do your own research first.

If you still feel it necessary to ask a question, or gain clarification, then I recommend:

* Opening an [issue](https://github.com/v0idx/byte_printer/issues)
...
* Check if other users have experienced (and maybe already solved!) the same issue you are having, ensure that there isn't already a report filed on the [issues page](https://github.com/v0idx/byte_printer/issues)
...
* Open an [issue](https://github.com/v0idx/byte_printer/issues/new)
...
This section guides you through submitting an enhancement suggestion for byte_printer, including new features and improvements to existing functionality.

##### Before Submitting an Enhancement

* Make sure that you are using the latest version
* Ensure that the functionality you are suggesting is not already covered, perhaps by a flag
* Perform a [search](https://github.com/v0idx/byte_printer/issues) to ensure that the enhancement has not already been suggested. If it has, please add a comment to the existing issue instead of opening a new one!
...
If the enhancement is within the main `byte_printer.rs` file, tests should be added to the `mod tests` at the end of the file.
